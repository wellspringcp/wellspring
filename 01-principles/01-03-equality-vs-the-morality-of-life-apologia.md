...
Note also that the pursuit of life allows and disallows a an identifiable, definite set of behaviours -- ingesting food nourishes while poison kills. Chocolate nourishes a human while it harms a dog. A moral code is an objective descriptions of the definite actions which promote or destroy the life of that species.
