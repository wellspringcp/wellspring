...
- Weapons which harness an ability to modify/write to the consciousness (whether the data/memory, goals or algorithms/logic) of a conscious agent.
...
The use, **by the government**, of technologies that grant the ability to read from the consciousness (whether the data/memory, goals or algorithms/logic) of a conscious agent are to be subject to those constraints outlined elsewhere in this constitution (_Chapter 08, Courts_) without exception.
